...
public class MenuController extends CustomAdapter implements Screen {
...

	{
		...
		// camera.update();
		/*
		 * { private Vector3 intersection = new Vector3(); private Plane PLANE = new Plane(new Vector3(0, 0, 1), Vector3.Zero);
		 ...
		 * Float.MAX_VALUE; } return screenCoords; } };
		 */
		// stage.getViewport().getCamera().position.add(0, 0, 600);
